...
public class MqConfig {
     ...
     */
    public static final String TOPIC = "aaron_mq_demo";
    public static final String PRODUCER_ID = "PID_aaronMqDemo";
    public static final String CONSUMER_ID = "CID_aaronMqDemo";
    ...
    public static final String ACCESS_KEY = "LTAI428dRA2UzLpV";
    public static final String SECRET_KEY = "JpvN8p1iX8avVaxMQ9TBQKB6LpKwqL";
